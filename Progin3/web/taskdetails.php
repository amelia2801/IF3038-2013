    ...
    <body onload="initialize()">
        ...
        <script	type="text/javascript">
			...
			function delTask() {
				...
				xmlhttp.open("POST","delTask.php",false);
			...
			function saveEditTask() {
				...
				xmlhttp.open("POST","editTask.php",false);
				xmlhttp.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
				xmlhttp.send(params);
			...
			function submitComment() {
				...
				if(isicomment.length > 0) {
					...
					xmlhttp.open("GET","addTaskComment.php?iduser="+iduser+"&idtugas="+idtugas+"&isikomentar="+isicomment,false);
					xmlhttp.send();
				}
				initComment();
			}
			...
			function deleteComment(id) {
				...
				xmlhttp.open("GET","delTaskComment.php?idcomment="+(document.getElementById((100+parseInt(id))).value),false);
				xmlhttp.send();
			...
			function getTaskName(idtugas) {
				...
				xmlhttp.open("GET","getTaskName.php?id="+idtugas,false);
				xmlhttp.send();
			...
			function getTaskStatus(idtugas) {
				...
				xmlhttp.open("GET","getTaskStatus.php?id="+idtugas,false);
				xmlhttp.send();
			...
			function getTaskDeadline(idtugas) {
				...
				xmlhttp.open("GET","getTaskDeadline.php?id="+idtugas,false);
				xmlhttp.send();
			...
			function getTaskAssignees(idtugas) {
				...
				xmlhttp.open("GET","getTaskAssignees.php?id="+idtugas,false);
				xmlhttp.send();
			...
			function getTaskTags(idtugas) {
				...
				xmlhttp.open("GET","getTaskTags.php?id="+idtugas,false);
				xmlhttp.send();
			...
			function getTaskComments(idtugas) {
				...
				xmlhttp.open("GET","getTaskComments.php?id="+idtugas+"&state="+state,false);
				xmlhttp.send();
			...
			function getTaskAttachments(idtugas) {
				...
				xmlhttp.open("GET","getTaskAttachments.php?id="+idtugas,false);
				xmlhttp.send();
