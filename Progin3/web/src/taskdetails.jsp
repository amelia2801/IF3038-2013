    ...
    <body onload="initialize();">
        ...
        <script	type="text/javascript">
            ...
            function editTask() {
                ...
                var temp2 = getTaskAssigneeWithoutCreator("<% out.print(request.getParameter("idtask"));%>");
...
//                            alert("b"+temp3);
                        ...
                        if(temp3=="") {
                            obj1.innerHTML = '<ul class="task"><h1>Edit Details</h1><li><label for="tugas" >Nama Tugas</label><input id="tugas" maxlength="25" name="tugas" type="text" value=' + temp1 + ' /><br><div id="errorTaskName"></div></li><li>' + blabla + '</li><li><label for="deadline">Deadline</label><select id="tanggallist" class="deadline" enabled></select><select id="bulanlist" class="deadline" enabled></select><select id="tahunlist" class="deadline" enabled></select></li><li><label for="asignee">Assignee</label><input id="asignee" name="asignee" type="text" onkeyup="checkSuggestion(this.value)" value="' + temp2 +'"/><div id="suggestion"></div><span>*dipisahkan dengan ","</span></li><li><label for="tag">Tag</label><input id="tag" name="tag" type="text" size="20"/><br><span>*dipisahkan dengan ","</span><br><button id="savebutton" name="savebutton" type="button" onclick="saveEditTask()"><b>SAVE</b></button><br><button id="delete" name="save" type="button" onclick="delTask()"><b>DELETE</b></button></li></ul><div id="comment"><div id="commentgroup" class="commentgroup"></div></div>';
                        } else {
//                            alert("c"+temp3);
                            obj1.innerHTML = '<ul class="task"><h1>Edit Details</h1><li><label for="tugas" >Nama Tugas</label><input id="tugas" maxlength="25" name="tugas" type="text" value=' + temp1 + ' /><br><div id="errorTaskName"></div></li><li>' + blabla + '</li><li><label for="deadline">Deadline</label><select id="tanggallist" class="deadline" enabled></select><select id="bulanlist" class="deadline" enabled></select><select id="tahunlist" class="deadline" enabled></select></li><li><label for="asignee">Assignee</label><input id="asignee" name="asignee" type="text" onkeyup="checkSuggestion(this.value)" value="' + temp2 +'"/><div id="suggestion"></div><span>*dipisahkan dengan ","</span></li><li><label for="tag">Tag</label><input id="tag" name="tag" type="text" size="20" value="' + temp3 + '" /><br><span>*dipisahkan dengan ","</span><br><button id="savebutton" name="savebutton" type="button" onclick="saveEditTask()"><b>SAVE</b></button><br><button id="delete" name="save" type="button" onclick="delTask()"><b>DELETE</b></button></li></ul><div id="comment"><div id="commentgroup" class="commentgroup"></div></div>';
                        }
...
//                }
            ...
            function delTask() {
                var xmlhttp;
                var idtugas = "<% out.print(request.getParameter("idtask"));%>";
...
//                alert("b");
            ...
            function initialize()
            {
                var taskname = getTaskName("<% out.print(request.getParameter("idtask"));%>");
                var taskstatus = getTaskStatus("<% out.print(request.getParameter("idtask"));%>");
                var taskdeadline = getTaskDeadline("<% out.print(request.getParameter("idtask"));%>");
                var temp = taskdeadline.split("-");
                var year = temp[0];
                var month = temp[1];
                var day = temp[2];
                var assignees = getTaskAssignees("<% out.print(request.getParameter("idtask"));%>");
                var creator = getTaskCreator("<% out.print(request.getParameter("idtask"));%>");
                var tags = getTaskTags("<% out.print(request.getParameter("idtask"));%>");
                var attachments = getTaskAttachments("<% out.print(request.getParameter("idtask"));%>");
...
//                    alert("tag kosong");
                ...
                if(assignees != undefined) {
                    ...
                    for(var i=0;i<split.length;i++) {
                        stringasign = stringasign + "<div class=taskasignee><a  href='searchProfile.jsp?user="+split[i]+"'>" + split[i] + "</a></div>;";
                    }
...
//                var assigneesid = getAssigneesId("<% out.print(request.getParameter("idtask"));%>");
                if(creator != "<% out.print(request.getParameter("iduser"));%>" || !isAssignee("<% out.print(request.getParameter("iduser"));%>","<% out.print(request.getParameter("idtask"));%>")) {
                    document.getElementById("edit").style.visibility = "hidden";
                }
//                if(!isAssignee("1","<% out.print(request.getParameter("idtask"));%>") && creator != "<?echo $_GET['iduser'];?>") {
//                    document.getElementById("edit").style.visibility = "hidden";
//                }
...
//            }
            ...
            function submitComment() {
                ...
                if(isicomment.length > 0) {
                        var iduser = "<% out.print(request.getParameter("iduser"));%>";
                        var idtugas = "<% out.print(request.getParameter("idtask"));%>";
...
//                alert("coment" + document.getElementById("thecreator"));
                var comments = getTaskComments("<% out.print(request.getParameter("idtask"));%>");
                if(comments != undefined) {
                    ...
                    for(var i=(thesplitcomments.length-1);i>=0;i--) {
                        ...
                        if(userid == <% out.print(request.getParameter("iduser"));%>) {
