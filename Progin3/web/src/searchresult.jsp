                                ...
                                <ul>
                                    <li id="Task1" >
                                        <%
                                            ...
                                            ResultSet rTugas = sTugas.executeQuery("SELECT id_user_pembuat FROM `tugas` WHERE id_tugas='"+id+"';");
                                            rTugas.next();
                                        %>
                                        <a id="namatugas" href="taskdetails.jsp?idtask=<% out.print(id);%>&iduser=<% out.print(rTugas.getString("id_user_pembuat"));%>"><%out.print(rs.getString("nama_tugas"));%></a>
                                    </li>
                                </ul>
                                <ul>
                                    <li>
