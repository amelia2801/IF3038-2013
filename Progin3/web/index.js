function checkUsername(){
	...
	else
	{
		...
		xmlhttp.open("GET","src/validReg.php?user="+obj.value+"&email="+email,true);
		xmlhttp.send();
	}
}
...
function checkEmail(){
	...
	if (reg.test(email.value)) 
	{
		...
		else
		{
			...
			xmlhttp.open("GET","src/validReg.php?user=''&email="+email.value,true);
			xmlhttp.send();
		}
	}
	else
	...
	if(typeof(Storage)!=="undefined")
	  {
		...
		if (localStorage.getItem('userlogin')){
			...
			xmlhttp.open("GET","src/getLocal.php?local="+localStorage.getItem('userlogin'),true);
			xmlhttp.send();
		}else{
			generateDate();
			//alert("Belum Login");
