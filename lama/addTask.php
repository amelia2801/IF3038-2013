<?php
	...
	$conn = mysqli_connect("localhost","root","","tubesprogin");
	...
	$query1 = "INSERT INTO tugas (id_tugas,nama_tugas,deadline,id_kategori) VALUES (NULL,'$taskname',DATE('$deadline'),'$id_category')";
